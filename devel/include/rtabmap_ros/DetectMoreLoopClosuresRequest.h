...
bool operator==(const ::rtabmap_ros::DetectMoreLoopClosuresRequest_<ContainerAllocator1> & lhs, const ::rtabmap_ros::DetectMoreLoopClosuresRequest_<ContainerAllocator2> & rhs)
{
