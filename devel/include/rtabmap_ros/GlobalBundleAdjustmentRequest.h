...
bool operator==(const ::rtabmap_ros::GlobalBundleAdjustmentRequest_<ContainerAllocator1> & lhs, const ::rtabmap_ros::GlobalBundleAdjustmentRequest_<ContainerAllocator2> & rhs)
{
