...
(cl:defclass <OdomInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (localBundleModels
    ...
    :type (cl:vector rtabmap_ros-msg:CameraModels)
   :initform (cl:make-array 0 :element-type 'rtabmap_ros-msg:CameraModels :initial-element (cl:make-instance 'rtabmap_ros-msg:CameraModels)))
   (localBundlePoses
...
(cl:defmethod localBundleIds-val ((m <OdomInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:localBundleIds-val is deprecated.  Use rtabmap_ros-msg:localBundleIds instead.")
  (localBundleIds m))

(cl:ensure-generic-function 'localBundleModels-val :lambda-list '(m))
(cl:defmethod localBundleModels-val ((m <OdomInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:localBundleModels-val is deprecated.  Use rtabmap_ros-msg:localBundleModels instead.")
  (localBundleModels m))

(cl:ensure-generic-function 'localBundlePoses-val :lambda-list '(m))
(cl:defmethod localBundlePoses-val ((m <OdomInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rtabmap_ros-msg:localBundlePoses-val is deprecated.  Use rtabmap_ros-msg:localBundlePoses instead.")
  (localBundlePoses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OdomInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'localBundleModels)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'rtabmap_ros-msg:CameraModels))
